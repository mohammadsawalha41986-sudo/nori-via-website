...
const SERVICES: SeedService[] = [
  ...
  { slug: 'video-production', nameEn: 'Video Production', nameAr: 'إنتاج الفيديو', category: 'creative-branding',
    summaryEn: 'Short-form video, campaign assets and the social content that carries the channel.',
    summaryAr: 'الفيديو القصير ومواد الحملات والمحتوى الاجتماعي الذي يحمل القناة.',
    whatWeDoEn: 'Concept, production and post — from a single-day reel shoot to a full campaign set with bilingual subtitles.',
    whatWeDoAr: 'الفكرة والإنتاج والمونتاج، من تصوير يوم واحد إلى حزمة حملة كاملة بترجمة ثنائية.',
